...
const imagesTop = allImages.slice(0, 4);     // First 4
const imagesBottom = allImages.slice(4, 8);  // Next 4
...
export default function Home() {
    ...
    const scrollSlider = (direction: 'left' | 'right') => {
        ...
        const scrollAmount = 260 + 16; // card width + margin
    ...
    return (
        <div>
                    ...
                    <div className="absolute inset-0 bg-black/40 flex items-center justify-center pb-[0px] md:pb-[200px] lg:pb-[300px]">
                        <div className="text-center space-y-4 px-4">
                            <h1 className="text-[#FFD42D] text-xl md:text-4xl font-heading tracking-wide">
                                Welcome to <br />
                                Kids Kingdom Entertainment
                            </h1>
                            <p className="text-white text-xs md:text-3xl">
                                Bahrain's Largest Fun & Thrills Destination For Children's Entertainment
                            </p>
                        </div>
                    </div>
            ...
            {/* Select Your Park Section */}
            <section
                className="bg-[#F4F4F4] py-12 px-4 text-center relative z-10 min-h-[50vh] bg-cover bg-center"
                style={{ backgroundImage: `url(${parkbg})` }}
            >
                <div className="md:absolute top-[-70%] left-1/5 mx-auto max-w-6xl">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6 place-items-center">
                        {/* Card 1 */}
                        <div className="bg-transparent overflow-hidden rounded-md md:w-[220px] w-full ">
                            <img src={manamapark} alt="Manama" className="w-full  h-auto  object-cover" />
                            <div className="py-2 font-semibold text-lg">Manama</div>
                        </div>

                        {/* Card 2 */}
                        <div className="bg-transparent overflow-hidden rounded-md md:w-[220px] w-full ">
                            <img src={marinapark} alt="Marina Beach" className="w-full  h-auto object-cover" />
                            <div className="py-2 font-semibold text-lg">Marina Beach</div>
                        </div>

                        {/* Card 3 */}
                        <div className="bg-transparent overflow-hidden rounded-md md:w-[220px] w-full ">
                            <img src={hiddpark} alt="Hidd" className="w-full  h-auto object-cover" />
                            <div className="py-2 font-semibold text-lg">Hidd</div>
                        </div>

                        {/* Card 4 */}
                        <div className="bg-transparent overflow-hidden rounded-md md:w-[220px] w-full ">
                            <img src={riffapark} alt="Riffa" className="w-full  h-auto object-cover" />
                            <div className="py-2 font-semibold text-lg">Riffa</div>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div className=" py-8 px-4 md:px-12 rounded-md  max-w-[1200px]  flex flex-col md:flex-row items-start gap-4 mx-auto">
                    ...
                    <div className="w-full md:w-2/3 my-auto">
                        ...
                        <div className="flex justify-between items-center max-w-xl">
                            <h2 className="text-[#009D48] font-semibold text-2xl md:text-4xl">
                                Offers & Combos
                            </h2>
                        ...
                        <p className="mt-2 text-sm text-gray-700 max-w-xl">
                            Looking for a day packed with excitement and great value? Check out
                            our special offers and combo packages designed for families, friends,
                        ...
                        >
                            {[...Array(6)].map((_, index) => (
                                <div
                                    key={index}
                                    className="min-w-[280px] max-w-[300px] rounded-lg overflow-hidden bg-white shadow snap-center"
                                >
                                    <img
                                        src={offerImg}
                                        alt={`Offer ${index + 1}`}
            ...
            <section className="py-16 bg-gradient-to-b from-[#FFE273] to-[#FFD42D]">
                <h2 className="text-3xl md:text-4xl font-heading text-[#3A3A3A] text-center mb-10">
                    Kids Kingdom Park
                </h2>
                    ...
                    <div className="marquee-track">
                        {[...imagesTop, ...imagesTop].map((img, i) => (
                            <img
                                ...
                                src={img}
                                alt={`top-${i}`}
                                className="w-[220px] md:w-[260px] mx-2 rounded-2xl shadow-lg object-cover"
                            />
                        ))}
                    </div>
                </div>
            ...
            <section className="py-10 bg-[#F4F4F4]">
                <h2 className="text-center text-2xl md:text-4xl font-heading font-semibold mb-8">
                    Hear from Kids Kingdom!
                </h2>
                ...
                <div className="max-w-6xl mx-auto px-4 md:px-10">
                    ...
                    <div className="flex gap-4 overflow-x-auto md:hidden no-scrollbar pb-4 snap-x snap-mandatory">
                        {[{ video: video1, thumbnail: thumbnail1 }, { video: video2, thumbnail: thumbnail2 }, { video: video3, thumbnail: thumbnail3 }].map((item, index) => (
                            <div
                                key={index}
                                className="relative min-w-[250px] max-w-[300px] rounded-lg overflow-hidden bg-black snap-center aspect-[3/4]"
                            >
                                <video
